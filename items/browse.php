...
<div class="container-wide">
    <div class="flex-column gallery-container">
        <?php foreach (loop('items') as $item): ?>
            <?php debug_to_console($item); ?>
        <div class="tri-column gallery-column">
            <a href="<?php 
                // echo item_url();
                echo metadata('item', 'permalink');
            ?>">
                <div class="gallery-img-container" style="background-image: url(<?php echo item_image_url(); ?>)"></div>
            </a>
